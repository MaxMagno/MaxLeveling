...
const HAIR: Record<string, string> = {
  negro: "#0c0c12",
  castano_oscuro: "#3a2418",
  castano_claro: "#7a4e2c",
  rubio: "#e6c87a",
  pelirrojo: "#c04a2a",
  blanco_plata: "#dfe7f0",
  azul_oscuro: "#1e3a6e",
    ...
    <div className="panel panel-violet p-5 space-y-4">
      ...
      <div className="grid place-items-center">
        <div className="relative">
          ...
          >
            ...
            />
            <path
              d={`M 35 215 Q 100 ${150 + phase * 4} 165 215 L 165 230 L 35 230 Z`}
              fill="var(--accent)"
              opacity={0.25 + phase * 0.1}
            />
            <path
              d="M 60 175 Q 100 150 140 175 L 140 215 L 60 215 Z"
              fill="oklch(0.25 0.06 270)"
              stroke="var(--primary)"
              strokeOpacity="0.5"
            />
            ...
            <path
              d="M 62 95 Q 60 55 100 50 Q 140 55 138 95 Q 135 75 100 72 Q 65 75 62 95 Z"
              fill={hair}
            />
      ...
      {quote && !compact && (
        <div className="panel p-3 scanline">
          <div className="text-[10px] uppercase tracking-widest text-violet mb-1">
            {avatar.name}
          </div>
