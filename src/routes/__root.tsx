  ...
  return (
    <div className="min-h-screen grid place-items-center px-4">
      <div className="panel panel-neon p-8 text-center max-w-md">
        ...
        <Link to="/" className="text-neon font-display tracking-widest text-sm">
          ← Volver al sistema
        </Link>
      </div>
    </div>
    ...
    <div className="min-h-screen grid place-items-center px-4">
      <div className="panel p-8 text-center max-w-md">
        ...
        <button
          ...
          className="text-neon font-display tracking-widest text-sm"
        >
          Reintentar
        </button>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Misiones diarias, XP, racha y afinidad. Eleva tu nivel cada día.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/e6c86d8b-5ff4-4ff4-9d96-f542a14b3a7b/id-preview-1d643b1c--55ccbe2b-c1cb-4083-a9a1-e41d5bc01d22.lovable.app-1779650240295.png",
      },
      {
        name: "twitter:image",
        content:
